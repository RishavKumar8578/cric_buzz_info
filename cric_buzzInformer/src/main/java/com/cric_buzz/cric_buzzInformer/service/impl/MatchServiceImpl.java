package com.cric_buzz.cric_buzzInformer.service.impl;

import com.cric_buzz.cric_buzzInformer.entities.Match;
import com.cric_buzz.cric_buzzInformer.repositories.MatchRepo;
...
//                update the match in database
    ...
    private void updateMatchInDb(Match match1) {
        ...
        System.out.println("match ka kya hai: "+match1.getBattingTeam());
        System.out.println("match ka kya update hai: "+match);
        if (match == null) {

            matchRepo.save(match1);

        }else {
            System.out.println("match ka update hua hai: "+match);
...
//        Match match=this.matchRepo.findAll();
